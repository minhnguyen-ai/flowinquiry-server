...
import { MultiCollapseMenuButton } from "@/components/themes/sidebar/common/classic-multi-collapse-button";
    ...
    return (
      <Collapsible open={isCollapsed} onOpenChange={setIsCollapsed}>
        <CollapsibleTrigger asChild>
          ...
          >
            {Icon && <Icon className={cn("h-6 w-6 mb-1 ")} />}
  ...
  return !collapsed || hovered ? (
                ...
                <Link href={href}>
                  <span
                    className={cn(
                      ...
                      {
                        "ring-4 bg-default ring-opacity-30 ring-default":
                          active,
                      },
                    )}
                  ></span>
    ...
    <DropdownMenu>
      ...
      >
        ...
        <DropdownMenuGroup>
          {submenus.map(
            ({ href, label, icon: SubMenuIcon, active, children }, index) =>
              children?.length === 0 ? (
                <DropdownMenuItem
                  key={index}
                  asChild
