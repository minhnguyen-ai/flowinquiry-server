...
public class SignupSMConfig {
    ...
    public static class StateMachinePersisterConfig {
        ...
        @Bean
        public StateMachineRuntimePersister<SignupStates, SignupEvents, String> stateMachineRuntimePersister(
    ...
    public static class StateMachineConfig extends EnumStateMachineConfigurerAdapter<SignupStates, SignupEvents> {
        ...
        private StateMachineRuntimePersister<SignupStates, SignupEvents, String> stateMachineRuntimePersister;

        @Override
        public void configure(StateMachineConfigurationConfigurer<SignupStates, SignupEvents> config) throws Exception {
    ...
    public static class ServiceConfig {
        ...
        public StateMachineService<SignupStates, SignupEvents> stateMachineService(
            ...
            StateMachineRuntimePersister<SignupStates, SignupEvents, String> stateMachineRuntimePersister
        ) {
