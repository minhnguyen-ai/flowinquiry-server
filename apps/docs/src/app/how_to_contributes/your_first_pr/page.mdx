...
```bash
git clone git clone git@github.com:<your-username>/flowinquiry.git
cd flowinquiry
```
...
Need help finding a place to contribute? Check out our [good first issues](https://github.com/flowinquiry/flowinquiry/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22good%20first%20issue%22).
