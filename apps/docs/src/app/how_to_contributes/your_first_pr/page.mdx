...
- **Frontend (Next.js)**: [https://github.com/flowinquiry/flowinquiry-frontend](https://github.com/flowinquiry/flowinquiry-frontend)
- **Backend (Spring Boot)**: [https://github.com/flowinquiry/flowinquiry-server](https://github.com/flowinquiry/flowinquiry-server)
