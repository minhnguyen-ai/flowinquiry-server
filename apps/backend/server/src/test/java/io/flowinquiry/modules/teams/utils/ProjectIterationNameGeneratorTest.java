...
public class ProjectIterationNameGeneratorTest {
    ...
    public  void testGetNextIterationWithValidData(){
        ...
        //When
        String nextIterationName1 = ProjectIterationNameGenerator.getNextIteration(currentIterationName1);
        String nextIterationName2 = ProjectIterationNameGenerator.getNextIteration(currentIterationName2);
        String nextIterationName3 = ProjectIterationNameGenerator.getNextIteration(currentIterationName3);
        String nextIterationName4 = ProjectIterationNameGenerator.getNextIteration(currentIterationName4);
        String nextIterationName5 = ProjectIterationNameGenerator.getNextIteration(currentIterationName5);
