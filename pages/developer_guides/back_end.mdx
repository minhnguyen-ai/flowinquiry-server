...
INFO 25048 --- [  restartedMain] io.flowinquiry.FlowInquiryApp.logStarting:50 : Starting FlowInquiryApp using Java 17.0.11 with PID 25048 (~/Projects/flowinquiry-server/server/build/classes/java/main started by <user> in ~/Projects/flowinquiry-server/server)
DEBUG 25048 --- [  restartedMain] io.flowinquiry.FlowInquiryApp.logStarting:51 : Running with Spring Boot v3.3.1, Spring v6.1.10
INFO 25048 --- [  restartedMain] io.flowinquiry.FlowInquiryApp.logStartupProfileInfo:660 : The following 2 profiles are active: "dev", "api-docs"
