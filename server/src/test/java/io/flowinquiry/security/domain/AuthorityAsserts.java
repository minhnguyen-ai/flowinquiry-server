...
public class AuthorityAsserts {
     ...
     * @param actual the actual entity
     */
    public static void assertAuthorityAllUpdatablePropertiesEquals(
     ...
     * @param actual the actual entity
     */
    public static void assertAuthorityAutoGeneratedPropertiesEquals(
            Authority expected, Authority actual) {}
    ...
    public static void assertAuthorityUpdatableFieldsEquals(Authority expected, Authority actual) {
        assertThat(expected)
                ...
                .satisfies(
                        e -> assertThat(e.getName()).as("check name").isEqualTo(actual.getName()));
    }
     ...
     * @param actual the actual entity
     */
    public static void assertAuthorityUpdatableRelationshipsEquals(
            Authority expected, Authority actual) {}
}
