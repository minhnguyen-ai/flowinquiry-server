...
import io.flexwork.security.rest.AccountResource;
import io.flexwork.security.rest.KeyAndPasswordVM;
import io.flexwork.security.rest.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testSaveAccount() throws Exception {
        ...
        User updatedUser =
                userRepository.findOneWithAuthoritiesByLogin(user.getLogin()).orElse(null);
